#!/usr/bin/env bash
# Build and install Sideous Drums (sideous-drums + sideous-drums-multi) into
# the standard Linux user plugin directories.
#
...
PLUGIN_NAMES=(sideous-drums sideous-drums-multi)
...
echo "==> Configuring/building sideous-drums..."
