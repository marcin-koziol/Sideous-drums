...
#define DISTRHO_PLUGIN_NAME    "Sideous Drums"
#define DISTRHO_PLUGIN_URI     "https://github.com/sideous/sideous-drums"
#define DISTRHO_PLUGIN_CLAP_ID "sideous.sideousdrums"

#define DISTRHO_PLUGIN_BRAND_ID  Side
#define DISTRHO_PLUGIN_UNIQUE_ID Drm1
...
#define DISTRHO_UI_DEFAULT_HEIGHT        714
